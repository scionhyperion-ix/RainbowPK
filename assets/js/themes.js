...
(function installRainbowThemes() {
  ...
  function installMobileStyles() {
    ensureStylesheet('assets/css/mobile.css', '(max-width: 760px)');
    ensureStylesheet('assets/css/mobile-front-timers.css', '(max-width: 760px)');
