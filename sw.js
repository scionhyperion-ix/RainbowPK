...
const CACHE_NAME = 'rainbow-shell-v36';
const APP_SHELL = [
  './',
  './index.html',
  ...
  './assets/css/theme-extras.css?v=1',
  './assets/css/theme-cocoa.css?v=1',
  './assets/css/app-theme-shell.css?v=2',
  './assets/css/search-field-fix.css?v=1',
  ...
  './assets/css/avatar-rendering.css?v=2',
  './assets/css/home-system-controls.css?v=2',
  ...
  './assets/css/mobile-member-editor-compact.css?v=1',
  ...
  './assets/js/home-system-controls.js?v=1',
